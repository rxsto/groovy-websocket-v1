package io.groovybot.websocket.io.config;
...
public class Configuration extends JSONObject {
    ...
    public Configuration init() {
        ...
        try {
            ...
            log.error("[io.groovybot.websocket.io.config.Configuration] Error while loading config!", e);
        }
        if (content == null || content.equals("")) {
            log.warn("[io.groovybot.websocket.io.config.Configuration] The config does not exists, started loading defaults!");
    ...
    private void save() {
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(configFile))) {
            ...
            log.error("[io.groovybot.websocket.io.config.Configuration] Error while saving io.groovybot.websocket.io.config.Configuration!", e);
        }
    }
